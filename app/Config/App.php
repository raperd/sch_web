...
class App extends BaseConfig
{
    ...
    */
     ...
     */
    /**
     * Cloudflare IP ranges sebagai trusted proxy.
     * Header X-Forwarded-For dan X-Forwarded-Proto dari Cloudflare akan dipercaya
     * sehingga site_url() / base_url() menghasilkan URL yang benar saat diakses
     * via Cloudflare Tunnel (https://xxx.trycloudflare.com).
     *
     * @var array<string, string>
     */
