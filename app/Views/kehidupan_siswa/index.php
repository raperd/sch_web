...
<?php if (!empty($galeri_kegiatan)): ?>
<!-- Galeri Kegiatan Siswa -->
<section class="py-5 bg-light">
    <div class="container">
        <div class="text-center mb-4">
            <span class="section-title">Galeri Kegiatan</span>
            <p class="text-muted mt-3">Momen-momen seru dari berbagai kegiatan siswa</p>
        </div>
        <div class="row g-3">
            <?php foreach ($galeri_kegiatan as $g): ?>
