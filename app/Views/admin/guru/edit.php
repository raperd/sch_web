...
<form method="post" action="<?= admin_url('guru/update/' . $guru['id']) ?>" enctype="multipart/form-data">
    <?= csrf_field() ?>
                    ...
                    <div id="periodeWrapper" class="mt-2"
                        ...
                        <div class="mb-2">
                            ...
                            <select name="status_keluar" class="form-select form-select-sm">
                                ...
                                <option value="purna_tugas" <?= old('status_keluar', $guru['status_keluar'] ?? '') === 'purna_tugas' ? 'selected' : '' ?>>Purna Tugas / Pensiun</option>
                                <option value="mutasi"      <?= old('status_keluar', $guru['status_keluar'] ?? '') === 'mutasi'      ? 'selected' : '' ?>>Mutasi ke Sekolah Lain</option>
                            </select>
                        </div>
                        <div class="row g-2">
                            <div class="col-6">
