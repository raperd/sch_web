                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul" class="form-control"
                            value="<?= old('judul') ?>" placeholder="mis. Juara 1 Olimpiade Matematika" required>
                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="tingkat" class="form-select" required>
                                ...
                                <?php foreach (
                                    ...
                                    <option value="<?= $val ?>" <?= old('tingkat') === $val ? 'selected' : '' ?>><?= $lbl ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row g-3 mt-1">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nama_siswa" class="form-control"
                                value="<?= old('nama_siswa') ?>" placeholder="mis. Budi Santoso, Siti Rahayu">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Pembimbing</label>
                            <input type="text" name="pembimbing" class="form-control"
                                value="<?= old('pembimbing') ?>" placeholder="Nama guru pembimbing">
                        </div>
                    </div>
                    ...
                    <div class="mt-3">
                        ...
                        <textarea name="deskripsi" class="form-control" rows="4"
                            placeholder="Keterangan tambahan tentang prestasi ini..."><?= old('deskripsi') ?></textarea>
                    </div>
                </div>
            </div>
        </div>

        <!-- Kolom Kanan: Foto & Opsi -->
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3 text-primary"><i class="bi bi-image me-2"></i>Foto</h6>
                    <div id="fotoWrap" class="mb-3 d-none text-center">
                        <img id="previewImg" src="" class="img-fluid rounded" style="max-height:140px;" alt="">
                    ...
                    <div class="form-text">Opsional. Dipotong otomatis rasio 16:9.</div>
                </div>
            </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" name="is_featured" value="1"
                            id="isFeatured" <?= old('is_featured') === '1' ? 'checked' : '' ?>>
