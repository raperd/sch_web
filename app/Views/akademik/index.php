            ...
            <?php foreach ($programs as $p): ?>
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0 shadow-sm h-100 text-center p-4">
                        <div class="rounded-circle bg-<?= $p['color'] ?> bg-opacity-10 mx-auto mb-3 d-flex align-items-center justify-content-center" style="width:72px;height:72px;">
                            <i class="bi <?= $p['icon'] ?> text-<?= $p['color'] ?>" style="font-size:2rem;"></i>
                        </div>
